            ...
            <div className="w-full min-h-[100vh] hidden max-md:flex flex-col items-center bg-white relative">
                <div className="w-full flex flex-col h-[370px] items-center ">
                    <div className="my-3 w-full flex items-center flex-col fixed top-0">
                        ...
                        <div className="w-[90%]  my-2 h-[200px] rounded-lg bg-black text-white">
                            <div className=" w-[90%] ml-4 mt-4">
                                <div className="font-[Bruv] text-[13px] ">Debit Card</div>
                                <div className="font-[Blud] text-[18px] my-1">₦3,250.00</div>
                            </div>
                            <div className="flex items-center my-10 justify-between w-[95%]">
                                <div className="flex flex-col ml-4">
                                    <div className="text-[14px] ">1234 **** **** 7890</div>
                                    <div className="text-[12px] text-[gray]">  10/26</div>
                                </div>
                                <div><RiMastercardFill className="text-[30px] text-[#ff5100d8]" /></div>
                            </div>
                        </div>
