                        ...
                        <div className="w-[70%] max-md:w-[90%] mt-3">
                            <div className="w-full h-[45px]">
                                ...
                                <select className="w-full h-full shadow-md rounded-md border outline-none pl-3 hover:cursor-pointer">
                                    <option value="" className="hover:cursor-pointer" >Select</option>
                                    <option value="" className="hover:cursor-pointer">MTN Data NG</option>
                                    <option value="" className="hover:cursor-pointer">Airtel Data NG</option>
                                    <option value="" className="hover:cursor-pointer">Glo Data NG</option>
                                    <option value="" className="hover:cursor-pointer">9 MOBILE Data NG</option>
                                </select>
                            </div>
                        </div>
                        <div className="w-[70%] max-md:w-[90%] mt-10">
                            <div className="w-full h-[45px]">
                                <label htmlFor="UserEmail" className="block text-[14px] font-[Blud]  text-gray-700"> Data Plan</label>
                                <select className="w-full h-full shadow-md rounded-md border outline-none pl-3 hover:cursor-pointer">
                                    <option value="" className="hover:cursor-pointer" >Select</option>
