          ...
          <div className="w-[90%] flex items-center justify-between h-full">
            ...
            >
              <div className="flex justify-between items-center w-full my-2">
                <div className="font-[Blud] text-[20px] text-[#40196D] ">
                  Ajcash
                </div>
                <div
                  className="flex items-center text-[#40196D] hover:cursor-pointer"
                  onClick={() => {
                    navigate(-1);
                  }}
                >
              ...
              <div className="w-[80%] my-3 flex items-center"></div>
              <button
                className={`w-[80%] rounded-3xl h-[45px] transition duration-300 ${
                  inputefilled
              ...
              <div className="my-3 text-[15px] flex items-center">
