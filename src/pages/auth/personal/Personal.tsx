      ...
      <div className="w-full h-auto flex flex-col items-center">
        <motion.div variants={motionVariant} initial="close" animate="open" className="flex w-[95%] items-center justify-between">
          <div className="w-[450px] max-md:w-full max-md:mt-10 mt-7">
            ...
            <div className="max-md:text-center mt-2 text-gray-600">Your Ajcash account comes with 25 free transfers to other banks every month. That’s up to 15,000 naira saved on transfers every year.</div>
