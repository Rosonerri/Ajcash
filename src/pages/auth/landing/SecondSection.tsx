import project1 from "../../../assets/woman.jpg"
import project from "../../../assets/bole.jpg"
const SecondSection = () => {
    return (
        <>
            <div className="w-full my-10 h-auto flex flex-col items-center">
                ...
                <div className="w-full flex items-center justify-between my-10  max-md:flex-col-reverse">
                    ...
                    <img className="max-md:w-[90%] border flex justify-center max-lg:w-[350px] w-[600px] h-[400px] max-md:border max-md:shadow-md rounded-2xl max-md:my-3 object-cover " loading="lazy" src={project1} />
                </div>
                <div className="w-full flex items-center justify-between my-10  max-md:flex-col-reverse">
                    <div className="w-[450px] max-lg:w-[400px] max-md:w-full ">
                    ...
                    <img className="max-md:w-[90%] border flex justify-center max-lg:w-[350px] w-[600px] h-[400px] max-md:border max-md:shadow-md rounded-2xl max-md:my-3 object-cover" loading="lazy" src={project} />
                </div>
            </div>
        </>
    )
