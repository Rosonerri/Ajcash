    ...
    return (
        <>
            ...
            <div className="w-full h-[60px] flex items-center justify-between z-[3]">
                <div className="w-full h-[60px] flex items-center justify-center fixed shadow-md bg-white">
                    <div className="w-[95%] flex items-center justify-between">
                        <div className="flex items-center">
                            <div className="font-[Blud] text-[#40196D]">Ajcash</div>
                        ...
                        <div className="flex items-center max-md:hidden">
                            <button className="text-[#40196D]">Login</button>
                            <button className="ml-7 px-3  py-2 rounded-lg text-white font-[Bruv] hover:bg-white hover:border-[#40196D] border transition-all duration-300 hover:text-[#40196D] bg-[#40196D]">Join Ajcash</button>
                        </div>
